 ...
 */
public class VideoRecorder extends AndroidTestCase {
     ...
     */
    public void recordSurface(Surface surface) {
        // QVGA at 2Mbps
        mWidth = 800; //320;
        mHeight = 480; // 240;
        mBitRate = 2000000;
        ...
        try {
        	Log.d(TAG, "before calling prepareEncoder");
            prepareEncoder(surface);
            Log.d(TAG, "before calling mInputSurface.makeCurrent()");
            mInputSurface.makeCurrent();

            for (int i = 0; i < NUM_FRAMES; i++) {
            	Log.d(TAG, "before calling  drainEncoder");
                // Feed any pending encoder output into the muxer.
                drainEncoder(false);

                // Generate a new frame of input.
                Log.d(TAG, "Generating surface frame " + String.valueOf(i));
    ...
    private static class CodecInputSurface {
        ...
        public CodecInputSurface(Surface surface) {
            ...
            eglSetup(); // Commented because egl has been already setup
        }
